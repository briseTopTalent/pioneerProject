(function () {
	var lists = (function () {
		...
		var getNormalizedEndPoint = function (container, offset) {
			...
			if (
				$_74mztagkjm0ofzg7.isListItemNode(container) &&
				$_74mztagkjm0ofzg7.isTextNode(node)
			) {
		...
		var outdentSelection = function (editor) {
			...
			if (listElements.length) {
				...
				var i = void 0,
					y = void 0;
				var root = $_3e5hb9gmjm0ofzgc.getClosestListRootElm(
					editor,
		...
		var getSelectedTextBlocks = function (editor, rng, root) {
			...
			global$5.each(siblings, function (node) {
				...
				if (global$4.isBookmarkNode(node)) {
					if (
						$_74mztagkjm0ofzg7.isTextBlock(editor, nextSibling) ||
		...
		var applyList = function (editor, listName, detail) {
			...
			global$5.each(getSelectedTextBlocks(editor, rng, root), function (block) {
				...
				if (
					sibling &&
					$_74mztagkjm0ofzg7.isListNode(sibling) &&
		...
		var isValidLists = function (list1, list2) {
			return (
				list1 &&
				list2 &&
				$_74mztagkjm0ofzg7.isListNode(list1) &&
		...
		var hasOnlyOneBlockChild = function (dom, elm) {
			...
			return (
				childNodes.length === 1 &&
				!$_74mztagkjm0ofzg7.isListNode(childNodes[0]) &&
		...
		var mergeLiElements = function (dom, fromElm, toElm) {
			...
			if (
				!$_74mztagkjm0ofzg7.isChildOfBody(dom, fromElm) ||
				!$_74mztagkjm0ofzg7.isChildOfBody(dom, toElm)
			) {
				return;
			}
		...
		var indent = function (li) {
			...
			if (
				sibling &&
				sibling.nodeName === "LI" &&
				$_74mztagkjm0ofzg7.isListNode(sibling.lastChild)
			) {
			...
			return function (e) {
				...
				editor.on("nodechange", function () {
					...
					var disable =
						...
						$_74mztagkjm0ofzg7.isFirstChild(listItemBlocks[0]);
