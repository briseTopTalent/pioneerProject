!(function () {
	...
	var t = tinymce.util.Tools.resolve("tinymce.PluginManager"),
		...
		p = function (t) {
			return (
				"boolean" == typeof t.link_assume_external_targets && t.link_assume_external_targets
			);
		},
		a = function (t) {
		...
		c = function (t) {
			if (!u.ie || 10 < u.ie) {
				...
				if (o) {
					...
					i.open(),
						i.write(
							'<meta http-equiv="refresh" content="0; url=' + l.DOM.encode(t) + '">'
						),
						i.close();
				}
			}
		...
		V = function (a, t) {
			...
			(u = E(v.getContent())),
				...
				R(a.settings) &&
					(f = { name: "title", type: "textbox", label: "Title", value: m.title }),
