	...
	var paste = (function () {
		...
		var shouldInformUserAboutPlainText = function (editor, userIsInformedState) {
			return (
				...
				$_dbkrisijjm0ofzoy.shouldPlainTextInform(editor)
			);
		};
		...
		function filterStyles(editor, validStyles, node, styleValue) {
			...
			global$3.each(styles, function (value, name) {
				...
				if (
					$_dbkrisijjm0ofzoy.getRetainStyleProps(editor) === "all" ||
		...
		var preProcess = function (editor, content) {
			return $_dbkrisijjm0ofzoy.shouldUseDefaultFilters(editor)
		...
		var postProcessFilter = function (editor, html, internal, isWordHtml) {
			...
			var postProcessArgs = $_4gidzbiijm0ofzow.firePastePostProcess(
				editor,
				tempBody,
				internal,
				isWordHtml
		...
		var filterContent = function (editor, content, internal, isWordHtml) {
			var preProcessArgs = $_4gidzbiijm0ofzow.firePastePreProcess(
				editor,
				content,
				internal,
				isWordHtml
		...
		var pasteHtml$1 = function (editor, html, internalFlag) {
			...
			var args = $_432mgditjm0ofzph.process(
				editor,
				$_21ba1xiqjm0ofzpc.unmark(html),
				internal
			);
		...
		var pasteText = function (editor, text) {
			...
			text = $_67xxvyirjm0ofzpe.convert(
				text,
		...
		var getClipboardContent = function (editor, clipboardEvent) {
			...
			return $_1340csizjm0ofzpu.isMsEdge()
		...
		var isKeyboardPasteEvent = function (e) {
			return (
				(global$4.metaKeyPressed(e) && e.keyCode === 86) || (e.shiftKey && e.keyCode === 45)
			);
		};
		var registerEventHandlers = function (editor, pasteBin, pasteFormat) {
			...
			editor.on("paste", function (e) {
				...
				var internal = hasContentType(
					clipboardContent,
					$_21ba1xiqjm0ofzpc.internalHtmlMime()
				);
		...
		var hasWorkingClipboardApi = function (clipboardData) {
			return (
				...
				$_1340csizjm0ofzpu.isMsEdge() !== true
			);
		};
		...
		var setup = function (editor, clipboard, draggingInternallyState) {
			...
			editor.on("dragover dragend", function (e) {
				if (
					$_dbkrisijjm0ofzoy.shouldPasteDataImages(editor) &&
		...
		function removeExplorerBrElementsAfterBlocks(editor, html) {
			...
			html = $_1340csizjm0ofzpu.filter(html, [[explorerBlocksRegExp, "$1"]]);
		...
		function removeWebKitStyles(editor, content, internal, isWordHtml) {
			...
			var webKitStyles;
			if (
				$_dbkrisijjm0ofzoy.shouldRemoveWebKitStyles(editor) === false ||
		...
		global.add("paste", function (editor) {
			if ($_1wddxcidjm0ofzo9.hasProPlugin(editor) === false) {
				...
				var pasteFormat = Cell(
					$_dbkrisijjm0ofzoy.isPasteAsTextEnabled(editor) ? "text" : "html"
				);
