		...
		<DashboardLayout pageTitle={"Locality"}>
			<div className="hk-pg-header">
				...
				<div className="d-flex">
					<Link href={`/${Pages.INCIDENT}/create`}>
						<button className="btn btn-primary btn-sm">Create New Incident</button>
					</Link>
				</div>
			</div>
			<div className="row">
		...
		<form onSubmit={handleSubmit}>
			...
			<div className="custom-control custom-checkbox mb-25">
				<input
					...
					onBlur={handleBlur}
				/>
				<label className="custom-control-label font-14" htmlFor="subscriber_only_comments">
					{" "}
					Subscriber Only Comment
				</label>
			</div>
			<div className="row">
				<StyledInput
