    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                user = _a.sent();
                if (!user) {
                    return [2 /*return*/, { error: true, message: "Couldn't find any user with that email" }];
                }
                resetPwHash = tokenizer(crypto.randomBytes(32).toString());
            ...
            case 2:
                _a.sent();
                return [2 /*return*/, { error: false, message: 'Password reset' }];
        }
    });
}); };
